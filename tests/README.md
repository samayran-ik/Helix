...
```text
[order-report] working directory: /path/to/helix
...
[order-report] reproduce with: /path/to/helix/venv/bin/python /path/to/helix/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
