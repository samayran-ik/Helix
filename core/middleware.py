...
INTERNAL_TOOL_TOKEN = os.environ.get("HELIX_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-HELIX-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-HELIX-Internal-Token), or
