...
- `HELIX_URL`: Base URL for the user's H E L I X instance, for example `http://127.0.0.1:7000`.
...
- Prefer `POST /api/codex/emails/draft-document` for Codex-written email replies. It creates an editable H E L I X Document with `language: "email"` and does not touch IMAP/send.
