...
def _usage() -> int:
    ...
    print("  helix_api.py emails draft-doc JSON_PAYLOAD", file=sys.stderr)
    print("  helix_api.py documents list [limit]", file=sys.stderr)
    print("  helix_api.py documents read DOC_ID", file=sys.stderr)
    print("  helix_api.py documents create JSON_PAYLOAD", file=sys.stderr)
    print("  helix_api.py documents delete DOC_ID", file=sys.stderr)
