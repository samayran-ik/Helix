...
- Prefer `POST /api/codex/emails/draft-document` for agent-written email replies. It creates an editable H E L I X Document with `language: "email"` and does not touch IMAP/send.
