...
#
# Produces:
#   dist/HELIX.app   — double-click: starts the local server (using this
#                         repo's venv) and opens the UI in an app-style window.
#   dist/HELIX.dmg   — drag-to-Applications disk image (the downloadable).
#
...
#!/bin/bash
# HELIX.app — start the local server and open the UI in an app window.
